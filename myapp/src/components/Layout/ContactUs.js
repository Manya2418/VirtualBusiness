    ...
    <>
      ...
      >
        <div className="bg-white shadow-xl p-8 rounded-xl w-full">
          <h2 className="text-3xl font-bold text-brand mb-6">Contact Us</h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="bg-brand-600 text-white px-6 py-2 rounded-md hover:bg-indigo-700 transition duration-300"
            >
              Send Message
            </button>
          </form>
